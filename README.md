...
| ----------------------------------------------------| -------------- | -------------- |
| `hmctspublic.azurecr.io/base/node:22-alpine`        | Alpine         | LTS 22         |
| `hmctspublic.azurecr.io/base/node:22-bookworm-slim` | Debian bookworm| LTS 22         |
...
```Dockerfile
### build image (Debian) ###
FROM hmctspublic.azurecr.io/base/node:22-bookworm-slim as base
